...
const NAV_ITEMS = [
  { id: "dash", icon: "◈", label: "工作台", group: null },
  { id: "idea", icon: "✦", label: "灵感对话", group: "创作工具" },
  { id: "general-image", icon: "▣", label: "常规生图", group: "创作工具" },
  { id: "paper-image", icon: "▤", label: "论文生图", group: "创作工具" },
  { id: "paper-ppt", icon: "▥", label: "论文生PPT", group: "创作工具" },
  { id: "plaza", icon: "◌", label: "作品广场", group: "作品中心" },
  { id: "mine", icon: "◎", label: "我的作品", group: "作品中心" },
  { id: "files", icon: "▦", label: "我的文件", group: "作品中心" },
  { id: "prompts", icon: "⌘", label: "Prompt 库", group: "作品中心" },
  { id: "tags", icon: "#", label: "标签管理", group: "作品中心" },
  { id: "account", icon: "⚙", label: "账号设置", group: null },
] as const;
